...
<body>
    ...
    <div class="container">
        <?php
        $subtitle = 'Đăng ký tài khoản mới tại đây.';
        ?>
        <br>
        <h2 class="text-center animate__animated animate__bounce">Đăng Ký Tài Khoản</h2>
        <div class="row">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form method="post" class="col-md-6 offset-md-3 border border-warning p-4 rounded rounded-3" id="dangky-form">
                <!-- Full Name -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone_number" class="form-control<?= isset($errors['phone_number']) ? ' is-invalid' : '' ?>" maxlength="10" id="phone_number" placeholder="Nhập số điện thoại" value="<?= isset($_POST['phone_number']) ? htmlspecialchars($_POST['phone_number']) : '' ?>" />
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" id="password" class="form-control<?= isset($errors['password']) ? ' is-invalid' : '' ?>" placeholder="Nhập mật khẩu (>=8 ký tự gồm chữ thường, chữ in hoa, kí tự đặc biệt)" value="<?= isset($_POST['password']) ? htmlspecialchars($_POST['password']) : '' ?>" />
